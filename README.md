...
This reaches the ultimate point in the no XML/scripts experience as you won't need to edit any XML (Maven pom) or groovy script at all : <strong>only Java code !</strong> <br/>
