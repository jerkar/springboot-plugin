...
public class JkSpringbootVersionManagement {
    ...
    public JkVersionProvider versionProvider() {
        return JkVersionProvider.of().and("antlr:antlr", "2.7.7").and("ch.qos.logback:logback-classic", "1.1.3")
                ...
                .and("com.google.code.gson:gson", "2.3.1").and("com.googlecode.json-simple:json-simple", "1.1.1")
                .and("com.h2database:h2", "1.4.190").and("com.jayway.jsonpath:json-path", "0.9.1")
                .and("com.samskivert:jmustache", "1.10").and("com.sun.mail:javax.mail", "1.5.4")
                .and("com.zaxxer:HikariCP", comZaxxerVersion).and("com.zaxxer:HikariCP-java6", comZaxxerVersion)
                .and("commons-beanutils:commons-beanutils", "1.9.2")
                .and("commons-collections:commons-collections", "3.2.1").and("commons-dbcp:commons-dbcp", "1.4")
                .and("commons-digester:commons-digester", "2.1").and("commons-pool:commons-pool", "1.6")
                ...
                .and("io.undertow:undertow-websockets-jsr", ioUndertowVersion).and("javax.cache:cache-api", "1.0.0")
                .and("javax.jms:jms-api", "1.1-rev-1").and("javax.mail:javax.mail-api", "1.5.4")
                .and("javax.servlet:javax.servlet-api", "3.1.0").and("javax.servlet:jstl", "1.2")
                .and("javax.transaction:javax.transaction-api", "1.2").and("jaxen:jaxen", "1.1.6")
                .and("joda-time:joda-time", "2.5").and("junit:junit", "4.12").and("log4j:log4j", "1.2.17")
                ...
                .and("org.apache.commons:commons-dbcp2", "2.0.1").and("org.apache.commons:commons-pool2", "2.2")
                .and("org.apache.derby:derby", "10.10.2.0").and("org.apache.httpcomponents:httpasyncclient", "4.0.2")
                .and("org.apache.httpcomponents:httpclient", "4.3.6").and("org.apache.httpcomponents:httpmime", "4.3.6")
                ...
                .and("org.apache.solr:solr-solrj", "4.7.2").and("org.apache.tomcat:tomcat-jdbc", orgApacheTomcatVersion)
                ...
                .and("org.apache.velocity:velocity", "1.7").and("org.apache.velocity:velocity-tools", "2.0")
                .and("org.aspectj:aspectjrt", orgAspectjVersion).and("org.aspectj:aspectjtools", orgAspectjVersion)
                .and("org.aspectj:aspectjweaver", orgAspectjVersion).and("org.codehaus.btm:btm", "2.1.4")
                ...
                .and("org.codehaus.janino:janino", "2.6.1").and("org.crashub:crash.cli", orgCrashubVersion)
                ...
                .and("org.flywaydb:flyway-core", "3.1").and("org.freemarker:freemarker", "2.3.23")
                ...
                .and("org.hornetq:hornetq-jms-server", orgHornetqVersion).and("org.hsqldb:hsqldb", "2.3.3")
                .and("org.javassist:javassist", "3.18.1-GA").and("org.jdom:jdom2", "2.0.6")
                .and("org.jolokia:jolokia-core", "1.2.3").and("org.liquibase:liquibase-core", "3.3.5")
                .and("org.mockito:mockito-core", "1.10.19").and("org.mongodb:mongo-java-driver", "2.12.5")
                ...
                .and("org.slf4j:jcl-over-slf4j", orgSlf4jVersion).and("org.slf4j:jul-to-slf4j", orgSlf4jVersion)
                .and("org.slf4j:log4j-over-slf4j", orgSlf4jVersion).and("org.slf4j:slf4j-api", orgSlf4jVersion)
                .and("org.slf4j:slf4j-jdk14", orgSlf4jVersion).and("org.slf4j:slf4j-log4j12", orgSlf4jVersion)
                .and("org.spockframework:spock-core", orgSpockframeworkVersion)
                .and("org.spockframework:spock-spring", orgSpockframeworkVersion)
                .and(Fwk.AOP, orgSpringframeworkVersion).and(Fwk.ASPECTS, orgSpringframeworkVersion)
                .and(Fwk.BEANS, orgSpringframeworkVersion).and(Fwk.CONTEXT, orgSpringframeworkVersion)
                .and(Fwk.CONTEXT_SUPPORT, orgSpringframeworkVersion).and(Fwk.CORE, orgSpringframeworkVersion)
                .and(Fwk.EXPRESSION, orgSpringframeworkVersion).and(Fwk.INSTRUMENT, orgSpringframeworkVersion)
                .and(Fwk.INSTRUMENT_TOMCAT, orgSpringframeworkVersion).and(Fwk.JDBC, orgSpringframeworkVersion)
                .and(Fwk.JMS, orgSpringframeworkVersion).and(Fwk.MESSAGING, orgSpringframeworkVersion)
                .and(Fwk.ORM, orgSpringframeworkVersion).and(Fwk.OXM, orgSpringframeworkVersion)
                .and(Fwk.TEST, orgSpringframeworkVersion).and(Fwk.TX, orgSpringframeworkVersion)
                .and(Fwk.WEB, orgSpringframeworkVersion).and(Fwk.WEBMVC, orgSpringframeworkVersion)
                .and(Fwk.WEBMVC_PORTLET, orgSpringframeworkVersion).and(Fwk.WEBSOCKET, orgSpringframeworkVersion)
                .and(Fwk.GROUP, "springloaded", "1.2.4.RELEASE").and(Amqp.AMQP, orgSpringframeworkAmqpVersion)
                .and(Amqp.ERLANG, orgSpringframeworkAmqpVersion).and(Amqp.RABBIT, orgSpringframeworkAmqpVersion)
                .and(Batch.CORE, orgSpringframeworkBatchVersion)
                .and(Batch.INFRASTRUCTURE, orgSpringframeworkBatchVersion)
                .and(Batch.INTEGRATION, orgSpringframeworkBatchVersion).and(Batch.TEST, orgSpringframeworkBatchVersion)
                ...
                .and(Boot.LOADER, orgSpringframeworkBootVersion).and(Boot.LOADER_TOOLS, orgSpringframeworkBootVersion)
                ...
                .and(Cloud.SPRING_SERVICE_CONNECTOR, orgSpringframeworkCloudVersion).and(Data.CQL, "1.1.4.RELEASE")
                .and(Data.CASSANDRA, "1.1.4.RELEASE").and(Data.COMMONS, "1.9.4.RELEASE")
                .and(Data.COUCHBASE, "1.2.4.RELEASE").and(Data.ELASTICSEARCH, "1.1.4.RELEASE")
                .and(Data.GEMFIRE, "1.5.4.RELEASE").and(Data.JPA, "1.7.4.RELEASE").and(Data.MONGODB, "1.6.4.RELEASE")
                .and(Data.MONGODB_CROSS_STORE, "1.6.4.RELEASE").and(Data.MONGODB_LOG4J, "1.6.4.RELEASE")
                .and(Data.NEO4J, "3.2.4.RELEASE").and(Data.REDIS, "1.4.4.RELEASE").and(Data.REST_CORE, "2.2.4.RELEASE")
                .and(Data.REST_WEBMVC, "2.2.4.RELEASE").and(Data.SOLR, "1.3.4.RELEASE")
                .and(Hateoas.HATEOAS, "0.16.0.RELEASE").and(Integration.AMQP, orgSpringframeworkIntegrationVersion)
                ...
                .and(Integration.XMPP, orgSpringframeworkIntegrationVersion).and(Mobile.DEVICE, "1.1.5.RELEASE")
                .and(Plugin.GROUP, "1.1.0.RELEASE").and(Security.ACL, orgSpringframeworkSecurityVersion)
                ...
                .and(Security.WEB, orgSpringframeworkSecurityVersion).and(Security.JWT, "1.0.3.RELEASE")
                .and(Social.CONFIG, "1.1.2.RELEASE").and(Social.CORE, "1.1.2.RELEASE")
                .and(Social.FACEBOOK, "2.0.2.RELEASE").and(Social.FACEBOOK_WEB, "2.0.2.RELEASE")
                .and(Social.LINKEDIN, "1.0.2.RELEASE").and(Social.SECURITY, "1.1.2.RELEASE")
                .and(Social.TWITTER, "1.1.1.RELEASE").and(Social.WEB, "1.1.2.RELEASE")
                .and(Ws.CORE, orgSpringframeworkWsVersion).and(Ws.SECURITY, orgSpringframeworkWsVersion)
                .and(Ws.SUPPORT, orgSpringframeworkWsVersion).and(Ws.TEST, orgSpringframeworkWsVersion)
                ...
                .and("org.yaml:snakeyaml", "1.14").and("redis.clients:jedis", "2.5.2").and("wsdl4j:wsdl4j", "1.6.3");
    }
    ...
    public JkDependencyExclusions dependencyExclusions() {
        return JkDependencyExclusions.builder()
                ...
                .on(Fwk.CORE, "commons-logging:commons-logging").on(Boot.STARTER, "commons-logging:commons-logging")
                ...
                .on(Ws.CORE, "commons-logging:commons-logging").on(Ws.SECURITY, "commons-logging:commons-logging")
                .on(Ws.SUPPORT, "commons-logging:commons-logging").on(Ws.TEST, "commons-logging:commons-logging")
                .build();
    }
