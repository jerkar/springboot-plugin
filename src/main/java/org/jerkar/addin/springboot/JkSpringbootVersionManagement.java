...
/**
 * Versions suggested by Spring boot. The defaults are the ones suggested by springboot version <code>1.2.7.RELEASE</code>
 * 
 * @author djeang
 * @formatter:off
 */
public class JkSpringbootVersionManagement {
	...
	return JkVersionProvider.of()
		...
		.and("org.glassfish.jersey.containers:jersey-container-servlet-core", orgGlassfishJerseyContainersVersion)
		...
		.and("org.spockframework:spock-spring", orgSpockframeworkVersion)
                .and(AOP, orgSpringframeworkVersion)
                .and(ASPECTS, orgSpringframeworkVersion)
                .and(BEANS, orgSpringframeworkVersion)
                .and(CONTEXT, orgSpringframeworkVersion)
                .and(CONTEXT_SUPPORT, orgSpringframeworkVersion)
                .and(CORE, orgSpringframeworkVersion)
                .and(EXPRESSION, orgSpringframeworkVersion)
                .and(INSTRUMENT, orgSpringframeworkVersion)
                .and(INSTRUMENT_TOMCAT, orgSpringframeworkVersion)
                .and(JDBC, orgSpringframeworkVersion)
                .and(JMS, orgSpringframeworkVersion)
                .and(MESSAGING, orgSpringframeworkVersion)
                .and(ORM, orgSpringframeworkVersion)
                .and(OXM, orgSpringframeworkVersion)
                .and(TEST, orgSpringframeworkVersion)
                .and(TX, orgSpringframeworkVersion)
                .and(WEB, orgSpringframeworkVersion)
                .and(WEBMVC, orgSpringframeworkVersion)
                .and(WEBMVC_PORTLET, orgSpringframeworkVersion)
                .and(WEBSOCKET, orgSpringframeworkVersion)
		.and(GROUP, "springloaded", "1.2.4.RELEASE")
		.and("org.springframework.amqp:spring-amqp", orgSpringframeworkAmqpVersion)
		.and("org.springframework.amqp:spring-erlang", orgSpringframeworkAmqpVersion)
		.and("org.springframework.amqp:spring-rabbit", orgSpringframeworkAmqpVersion)
		.and("org.springframework.batch:spring-batch-core", orgSpringframeworkBatchVersion)
		.and("org.springframework.batch:spring-batch-infrastructure", orgSpringframeworkBatchVersion)
		.and("org.springframework.batch:spring-batch-integration", orgSpringframeworkBatchVersion)
		.and("org.springframework.batch:spring-batch-test", orgSpringframeworkBatchVersion)
		...
		.and("org.springframework.cloud:spring-cloud-cloudfoundry-connector", orgSpringframeworkCloudVersion)
		.and("org.springframework.cloud:spring-cloud-core", orgSpringframeworkCloudVersion)
		.and("org.springframework.cloud:spring-cloud-heroku-connector", orgSpringframeworkCloudVersion)
		.and("org.springframework.cloud:spring-cloud-localconfig-connector", orgSpringframeworkCloudVersion)
		.and("org.springframework.cloud:spring-cloud-spring-service-connector", orgSpringframeworkCloudVersion)
		...
		.and("org.springframework.ws:spring-ws-core", orgSpringframeworkWsVersion)
		.and("org.springframework.ws:spring-ws-security", orgSpringframeworkWsVersion)
		.and("org.springframework.ws:spring-ws-support", orgSpringframeworkWsVersion)
		.and("org.springframework.ws:spring-ws-test", orgSpringframeworkWsVersion)
